...
function ChangePlanModal({
  ...
  return (
    ...
    >
      {/* Header */}
      <div className="sticky top-0 z-10 flex items-center px-5 pt-12 pb-2" style={{ background: '#050d1f' }}>
        <button
          type="button"
          onClick={onClose}
          ...
          {(['monthly', 'annually'] as BillingCycle[]).map((cycle) => (
            <button
              ...
              className={cn(
                ...
                billing === cycle ? 'bg-white text-[#050d1f] shadow' : 'text-white/70 hover:text-white'
              )}
            >
          ...
          {PLANS.map((plan) => {
            ...
            return (
              <button
                ...
                style={{
                  background: selected ? 'rgba(20, 42, 100, 0.65)' : 'rgba(16, 32, 72, 0.55)',
                  border: selected
                    ? '1.5px solid rgba(74, 159, 213, 0.5)'
                  ...
                  <div className="flex items-center gap-2.5">
                    ...
                    <div
                      className={cn(
                        ...
                        selected ? 'bg-green-500' : 'border-2 border-white/35 bg-transparent'
                      )}
                    >
                      {selected && <CheckIcon />}
                    </div>
                    ...
                    {plan.usage.map((u, i) => (
                      <li key={i} className="flex items-start gap-2 text-xs">
                        ...
                        <span>
                          ...
                          <span className="text-white/55">{u.suffix}</span>
                        </span>
                      </li>
                    ))}
                  </ul>
      ...
      <div className="sticky bottom-0 px-5 pb-8 pt-3" style={{ background: '#050d1f' }}>
        <button
          type="button"
          onClick={onClose}
          className={cn(
